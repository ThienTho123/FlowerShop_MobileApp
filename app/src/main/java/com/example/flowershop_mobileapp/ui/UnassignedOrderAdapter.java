...
public class UnassignedOrderAdapter extends RecyclerView.Adapter<UnassignedOrderAdapter.OrderViewHolder> {
    ...
    public OrderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.unassigned_order_item, parent, false);
        return new OrderViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull UnassignedOrderAdapter.OrderViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            Intent intent = new Intent(v.getContext(), UnassignedOrderDetailActivity.class);
